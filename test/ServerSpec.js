    ...
    describe('Session Parser', function() {
      ...
      it('creates a new hash for each new session', function(done) {
        ...
        sessionParser(requestWithoutCookies, response, function() {
          ...
          sessionParser(secondRequestWithoutCookies, responseTwo, function() {
      ...
      it('clears and resets the cookie if there is no session assigned to the cookie', function(done) {
        ...
        sessionParser(requestWithMalicioousCookie, response, function() {
      ...
      it('removes session from database if used by a different browser', function(done) {
        ...
        sessionParser(requestWithoutCookie, response, function() {
          ...
          db.query('SELECT * FROM sessions WHERE hash = ?', newCookie, function(err, row) {
            ...
            sessionParser(maliciousRequestWithStolenCookie, secondResponse, function() {
